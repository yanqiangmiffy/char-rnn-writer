...
tf.app.flags.DEFINE_string('result_dir',os.path.abspath('./result'),'trained model save path.')
tf.app.flags.DEFINE_string('file_path',os.path.abspath('./data/poems.txt'),'file of poems dataset.')
...
def train():
    ...
    end_points=char_rnn(model='lstm',input_data=input_data,output_data=output_targets,vocab_size=len(
